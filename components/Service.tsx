      ...
      <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               Interview Generator Community Question Library Interview Generator ,competencies, and skills to assess during the interview.
               </p>
               <Link
                  href="/student/inter"
               >
         ...
         <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p className="text-body-color">
               This little project was created for students who are having trouble coming up with a distinctive capstone title. This capstone title generator will help you come up with the best capstone title
               </p>
               <Link
         ...
         <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p className="text-body-color">
               How to write a project description Here are some steps you can follow when writing your own project description: 1. Assign a title The first step toward creating an effective project description .
               </p>
               <Link
                  href="/student/report"
               >
         ...
         <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
               ...
               <p className="text-body-color">
               Side Project Generator Generate your next coding project 🤓 Note: some projects may be in a specific language but you can try doing them in a language
               </p>
               <Link
         ...
         <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <p className="text-body-color">
                            Recommended courses & skills for various domains.
                            List of popular jobs titles in various industries.
               ...
               <p 
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <p className="text-body-color">
                            Generate project ideas from skills & knowledge learned.
                            List of popular project categories with sample project examples.
                        </p>
                        <Link
                  href="/"
               >
               <p 
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <h4 className="mb-3 text-xl font-semibold text-dark">
                            Sample project report generation
                        </h4>
                        <p className="text-body-color">
                            Explanation of what should be included in a project report.
                            Tips for writing clear & concise description with examples.
                        </p>
                        <Link
                  href="/"
               >
               <p 
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <p className="text-body-color">
                            List of frequent questions & how to answer them.
               ...
               <p 
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <p className="text-body-color">
                            Tips for writing an effective resume & avoiding common mistakes.
                            Tools & resources for building resume with example. 
                        </p>
                        <Link
                  href="/"
               >
               <p 
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div className="p-10 md:px-7 xl:px-10 rounded-[20px] shadow-md hover:shadow-lg mb-8">
                        ...
                        <p className="text-body-color">
                            Tips for building & handling social media accounts for attracting potential recruters.
