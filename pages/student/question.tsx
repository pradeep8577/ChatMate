...
export default function Home() {
  ...
  const prompt = `Can you create a 10 examples of ieee paper titles using ${text} and make sure that the titles are unique and can you provide some reference for it.. You can use the following as a guide: Please make this in a list format and add a colon (:) at the end of each title.`;
