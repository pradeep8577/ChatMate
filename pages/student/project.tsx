...
export default function Home() {
  ...
  const prompt = `Generate 10 project based name on ${text}. Make sure to generate 10 and its relevant and not out out of context.`;
    ...
    <>
      <div className={`flex flex-col items-center m-0 `}>
        ...
        <div className="flex flex-col items-center w-full max-w-screen-md px-4 pt-14 md:px-0">
          <div className="flex items-center p-2 my-6 space-x-2 rounded-full select-none dark:bg-zinc-800 dark:hover:bg-zinc-700 bg-slate-100 hover:bg-slate-200">
            {/* <a
