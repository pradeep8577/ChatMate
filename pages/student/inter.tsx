...
export default function Home() {
  ...
  const prompt = `Generate 10 intervie Job interview questions based name on ${text}. Make sure to generate 10 and its relevant and not out out of context.`;
    ...
    <>
      <div className={`flex flex-col items-center m-0 `}>
        ...
        <div className="flex flex-col items-center w-full max-w-screen-md px-4 pt-14 md:px-0">
          ...
          <p className="mt-5 text-slate-500">4,118 Job interview questions Generator generated so far.</p>
          ...
          >
            ...
            <input
              ...
              placeholder="example. ReactJS, CPP, Javascript"
              id="search-box"
            />
            <button
